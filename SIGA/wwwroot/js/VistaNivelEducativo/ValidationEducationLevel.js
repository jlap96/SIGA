document.addEventListener('DOMContentLoaded', function () {
    ...
    const inputCostoInscripcion = document.querySelector('#CostoInscripcion');
    const inputCostoColegiatura = document.querySelector('#CostoColegiatura');

    //Add events
    inputNombre.addEventListener('blur', validar);
    inputCostoInscripcion.addEventListener('blur', validar);
    inputCostoColegiatura.addEventListener('blur', validar);
